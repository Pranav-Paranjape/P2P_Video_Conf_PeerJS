...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    peer.on('open', function () {
        document.getElementById("heading").innerHTML = peer.id;
    ...
    document.getElementById("connect-to-peer-btn").addEventListener("click", function(){
        ...
        if (peer_id) {
            ...
            // document.getElementById("heading").innerHTML="connection successful";
            //conn.on('data', handleMessage);
        }else{
    ...
    requestLocalVideo({
        ...
        error: function(err){
            alert("Cannot get access to your camera and audio !");
            console.error(err);
        }
    });
